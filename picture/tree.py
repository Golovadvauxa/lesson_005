...
def draw_tree(start_point, angle, length):
    ...
    draw_tree(start_point=v1.end_point, angle=angle - random_angle1, length=length * random_length1)
    draw_tree(start_point=v2.end_point, angle=angle + random_angle2, length=length * random_length2)
